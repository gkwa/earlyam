...
import (
	...
	"github.com/gkwa/earlyam/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.earlyam.yaml)")
